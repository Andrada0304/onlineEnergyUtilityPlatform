...
class EditDeviceComponent extends Component {
    ...
    componentDidMount(){
        deviceService.getDeviceById(this.state.id).then( (res) =>{
            let device = res.data;
            this.setState({description: device.description,
                address : device.address,
                maximumEnergyConsumption : device.maximumEnergyConsumption,
                avgEnergyConsumption: device.avgEnergyConsumption
            });
        });
    }
    editDevice = (e) => {
                        ...
                        <div className = "card col-md-6 offset-md-3 offset-md-3">
                            ...
                            <div className = "card-body">
                                <form>
                                    ...
                                    <button className="btn btn-success" onClick={this.editDevice}>Edit</button>
...
export default withRouter(EditDeviceComponent)