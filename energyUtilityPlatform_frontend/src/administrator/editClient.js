...
class EditClientComponent extends Component {
    ...
    getTitle(){
        return <h3 className="text-center">Edit Client</h3>
    }
    render() {
        return (
            <div>
                        ...
                        <div className = "card col-md-6 offset-md-3 offset-md-3">
                            ...
                            <div className = "card-body">
                                <form>
                                    ...
                                    <button className="btn btn-success" onClick={this.editClient}>Save</button>
...
export default withRouter(EditClientComponent)